...
var normal_upsides = [
	...
	upgrade_data.new("+%d\nPlayer Laser Damage", "player_laser_damage", 1),
...
var rare_upsides = [
	...
	upgrade_data.new("+%d\nPlayer Laser Damage", "player_laser_damage", 3),
...
var rare_downsides = [
	...
	upgrade_data.new("%d\nPlayer Laser Damage", "player_laser_damage", -2),
...
var legendary_upsides = [
	...
	upgrade_data.new("+%d\nPlayer Laser Damage", "player_laser_damage", 10),
...
var exotic_upsides = [
	...
	upgrade_data.new("+%d\nPlayer Laser Damage", "player_laser_damage", 50),
...
var exotic_downsides = [
	...
	upgrade_data.new("%d\nPlayer Laser Damage", "player_laser_damage", -15),
